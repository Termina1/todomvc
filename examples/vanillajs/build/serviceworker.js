...
/***/ function(module, exports, __webpack_require__) {
	...
	var whiteList = urlsToCache.concat(['/get']);
	...
	self.addEventListener('fetch', function (event) {
	  event.respondWith(caches.match(event.request, { cacheName: CACHE_NAME }).then(function (response) {
	    return fetch(event.request).then(function (response) {
	      ...
	      var isAllowed = whiteList.includes(response.url.replace(host, ''));
	...
	self.addEventListener('push', function (event) {
	  var tag = 'unfinished-todo';
	  var title = 'Unfinished business!';
	  event.waitUntil(fetch('/get').then(function (r) {
	    return r.json();
	  }).then(function (r) {
	...
	self.addEventListener('notificationclick', function (event) {
	  event.waitUntil(clients.matchAll({
	    ...
	    for (var i = 0; i < clientList.length; i++) {
	      ...
	      if (client.url.indexOf(location.host) !== false) return client.focus();
	    }
